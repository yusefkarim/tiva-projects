...
//July 06, 2017
/***This could of been done in a more intuitive way if I included string.h***/
...
//This will fill needed chars wtih spaces then replace the ones with numbers accordingly
